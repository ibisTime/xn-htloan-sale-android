...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected void startCrop(ArrayList<String> list) {
        UCropMulti.UCropMultiOptions UCropMultiOptions = new UCropMulti.UCropMultiOptions();
        int toolbarColor = AttrsUtils.getTypeValueColor(this, R.attr.picture_crop_toolbar_bg);
        int statusColor = AttrsUtils.getTypeValueColor(this, R.attr.picture_crop_status_color);
        int titleColor = AttrsUtils.getTypeValueColor(this, R.attr.picture_crop_title_color);
        UCropMultiOptions.setToolbarColor(toolbarColor);
        UCropMultiOptions.setStatusBarColor(statusColor);
        UCropMultiOptions.setToolbarWidgetColor(titleColor);
        UCropMultiOptions.setCircleDimmedLayer(config.circleDimmedLayer);
        UCropMultiOptions.setShowCropFrame(config.showCropFrame);
        UCropMultiOptions.setDragFrameEnabled(config.isDragFrame);
        UCropMultiOptions.setShowCropGrid(config.showCropGrid);
        UCropMultiOptions.setScaleEnabled(config.scaleEnabled);
        UCropMultiOptions.setRotateEnabled(config.rotateEnabled);
        UCropMultiOptions.setHideBottomControls(true);
        UCropMultiOptions.setCompressionQuality(config.cropCompressQuality);
        UCropMultiOptions.setCutListData(list);
        UCropMultiOptions.setFreeStyleCropEnabled(config.freeStyleCropEnabled);
