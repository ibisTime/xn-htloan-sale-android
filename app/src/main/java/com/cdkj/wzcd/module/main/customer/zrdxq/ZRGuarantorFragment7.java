...
import com.cdkj.wzcd.databinding.FargmentZrGuarantor7Binding;
 ...
 * 担保人信息
 */
public class ZRGuarantorFragment7 extends BaseLazyFragment {

    private FargmentZrGuarantor7Binding mBinding;

    private ZXDetialsBean.ListBean data;

    public static Fragment getInstance() {
        ZRGuarantorFragment7 fragment = new ZRGuarantorFragment7();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.fargment_zr_guarantor7, container, false);
        initView();
