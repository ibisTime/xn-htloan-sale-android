...
import com.cdkj.wzcd.databinding.LayoutMyInputHorizontal2Binding;
...
public class MyEditLayout2 extends LinearLayout {

    private LayoutMyInputHorizontal2Binding mBinding;
    ...
    public MyEditLayout2(Context context) {
        this(context, null);
    }

    public MyEditLayout2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyEditLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MyEditLayout2, 0, 0);
        txtHint = typedArray.getString(R.styleable.MyEditLayout2_txt_input_hint);
        txtTitle = typedArray.getString(R.styleable.MyEditLayout2_txt_input_title);
        txtTitleRight = typedArray.getString(R.styleable.MyEditLayout2_txt_input_title_right);
        inputType = typedArray.getString(R.styleable.MyEditLayout2_inputType);
    ...
    private void init(Context context) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.layout_my_input_horizontal2, this, true);
