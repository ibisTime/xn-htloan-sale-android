...
import com.cdkj.wzcd.databinding.LayoutMySelectHorizontal2Binding;
...
public class MySelectLayout2 extends LinearLayout {

    public static int DATA_DICTIONARY = 0;
    public static int SYSTEM_PARAMETER = 1;

    private Context context;
    private LayoutMySelectHorizontal2Binding mBinding;
    ...
    public MySelectLayout2(Context context) {
        this(context, null);
    }

    public MySelectLayout2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySelectLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MySelectLayout2, 0, 0);
        txtTitle = typedArray.getString(R.styleable.MySelectLayout2_txt_select_title);
        txtContent = typedArray.getString(R.styleable.MySelectLayout2_txt_select_content);
    ...
    private void init(Context context) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.layout_my_select_horizontal2, this, true);
