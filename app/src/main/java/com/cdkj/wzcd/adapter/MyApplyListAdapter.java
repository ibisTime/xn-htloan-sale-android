...
import com.cdkj.wzcd.module.business.join_approval.JoinApplyActivity;
...
public class MyApplyListAdapter extends BaseQuickAdapter<NodeListModel, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, NodeListModel item) {
        ...
        mBinding.myItemNlNameAndTypeAmount.setContent(item.getApplyUserName(), RequestUtil.formatAmountDivSign(item.getAdvanceFundAmount()));
