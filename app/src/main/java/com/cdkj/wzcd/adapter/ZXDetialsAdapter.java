...
public class ZXDetialsAdapter extends BaseQuickAdapter<ZXDetialsBean.ListBean, BaseViewHolder> {

    private ItemCreditListBinding mBinding;
    private List<DataDictionary> mType;


    public ZXDetialsAdapter(@Nullable List<ZXDetialsBean.ListBean> data) {
