...
import com.cdkj.wzcd.databinding.ActivityWebviewMessageBinding;
 ...
 * 介绍类webview
 */
public class WebViewMessageActivity extends AbsBaseLoadActivity {

    private SslErrorHandler mHandler;

    private ActivityWebviewMessageBinding mBinding;
...
//    private WebView webView;
    ...
    public static void openkey(Activity activity, String title, String code) {
        ...
        Intent intent = new Intent(activity, WebViewMessageActivity.class);
     ...
     * @param activity 上下文
     */
    public static void openContent(Context activity, String title, String date, String type, String content) {
        if (activity == null) {
            return;
        }
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.activity_webview_message, null, false);
...
//                handler.proceed();  // 接受所有网站的证书
                ...
                mHandler = handler;
                AlertDialog.Builder builder = new AlertDialog.Builder(WebViewMessageActivity.this);
...
//        setTopTitle(getIntent().getStringExtra("title"));
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            if (TextUtils.isEmpty(getIntent().getStringExtra("content"))) {
                ...
                String date = DateUtil.formatStringData(getIntent().getStringExtra("date"), DateUtil.DEFAULT_DATE_FMT);
                mBinding.tvDate.setText(date);
                mBinding.tvType.setText(getIntent().getStringExtra("type"));
